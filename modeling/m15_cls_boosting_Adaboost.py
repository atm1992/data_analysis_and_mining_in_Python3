...
# 此案例中，AdaBoost的效果不如随机森林

def cls_adaboost(X_train,X_validation,X_test,Y_train,Y_validation,Y_test):
    models = []
...
if __name__ == '__main__':
    ...
    cls_adaboost(X_train,X_validation,X_test,Y_train,Y_validation,Y_test)